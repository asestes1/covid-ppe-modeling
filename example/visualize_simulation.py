...
event_file = os.path.join(resource_dir, "sim_out_event.csv")
patient_file = os.path.join(resource_dir, "patient_out_event.csv")
...
matplotlib.pyplot.plot(x_axis, cumulative_exits, label="Exited")
